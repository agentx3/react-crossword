...
function Cell({ cellData, onClick, focus, highlight, }) {
    ...
    return ((0, jsx_runtime_1.jsxs)("g", Object.assign({ onClick: handleClick, style: { cursor: 'default', fontSize: `${fontSize}px` }, className: answer === guess && guess !== ' ' ? 'clue-cell-correct' : 'clue-cell', id: `R${row}C${col}` }, { children: [(0, jsx_runtime_1.jsx)("rect", { x: x + cellPadding, y: y + cellPadding, width: cellInner, height: cellInner, fill: focus
                    ? focusBackground
                    : highlight
                        ? highlightBackground
